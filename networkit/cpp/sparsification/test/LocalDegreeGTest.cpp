...
protected:
    static double getScore(const GraphW &g, node x, node y, count rankX, count rankY);
};
...
**/
double LocalDegreeGTest::getScore(const GraphW &g, node x, node y, count rankX, count) {
