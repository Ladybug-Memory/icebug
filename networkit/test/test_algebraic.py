...
class TestAlgebraic(unittest.TestCase):
	...
	def testEigenvectorsReverse(self):
		...
		# The eigenvalue with smallest real part (one of the complex conjugate pair)
		self.assertAlmostEqual(eigen[0][0].real, -2.495689365014214, delta=0.01)
		self.assertAlmostEqual(abs(eigen[0][0].imag), 0.517336521966834, delta=0.01)
